...
public:
  ...
  virtual std::any visitCharLiteral(MinhaLinguagemParser::CharLiteralContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitFuncaoMain(MinhaLinguagemParser::FuncaoMainContext *ctx) override {
    return visitChildren(ctx);
  }
